...
public class EmployeeRoster {
    ...
    public void displayAllEmployee() {
        ...
        for (Employee e : empList) {
            ...
            if (e instanceof BasedPlusCommissionEmployee) {
                System.out.printf("%,10.2f|", ((BasedPlusCommissionEmployee) e).computeSalary());
            } else if (e instanceof CommissionEmployee) {
                System.out.printf("%,10.2f|", ((CommissionEmployee) e).computeSalary());
            } else if (e instanceof PieceWorkerEmployee) {
                System.out.printf("%,10.2f|", ((PieceWorkerEmployee) e).computeSalary());
            } else if (e instanceof HourlyEmployee) {
                System.out.printf("%,10.2f|", ((HourlyEmployee) e).computeSalary());
            }
