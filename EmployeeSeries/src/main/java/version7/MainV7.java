...
public class MainV7 {
    public static void main(String[] args) {
        ...
        CommissionEmployee s1 = new CommissionEmployee(103, new Name("Jomar", "P.", "cunado"), new Date(02,14,2004), new Date(10,14,2024), 1600);
        BasedPlusCommissionEmployee b1 = new BasedPlusCommissionEmployee(104, new Name("uary", "Q.", "toledo"), new Date(01,21,2004), new Date(10,14,2024), 1800, 1200);
