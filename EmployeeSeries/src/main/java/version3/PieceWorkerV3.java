 ...
 * @author cheska
 */
public class PieceWorkerV3 extends Employee{
    private int totalPiecesFinished;
    private double ratePerPiece;
    
    public PieceWorkerV3() {}
    
    public PieceWorkerV3(int empID, Name empName) {
        super(empName, empID);
    }
    
    public PieceWorkerV3(int empID, Name empName, Date birthDate, Date startDate) {
        super(empID, empName, birthDate, startDate);
    }
    
    public PieceWorkerV3( int empID, Name empName, Date birthDate, Date startDate, int totalPiecesFinished, double ratePerPiece) {
