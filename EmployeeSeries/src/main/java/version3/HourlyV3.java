 ...
 * @author cheska
 */
public class HourlyV3 extends Employee{
    private float totalHoursWorked;
    private double ratePerHour;
    
    public HourlyV3() {}
    
    public HourlyV3(int empID, Name empName) {
        super(empName, empID);
    }
    
    public HourlyV3(int empID, Name empName, Date birthDate, Date startDate) {
        super(empID, empName, birthDate, startDate);
    }
    
    public HourlyV3(int empID, Name empName, Date birthDate, Date startDate, float totalHoursWorked, double ratePerHour) {
        super(empID, empName, birthDate, startDate);
